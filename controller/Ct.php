...
if($method == "OPTIONS") {
    ...
    /*Inicio Métodos para CRUD Articulo*/
        ...
        break;
        case "Upart":
            $datos=$categoria->update_articulos($body["id"],$body["nom_articulo"],$body["sub_categoria"],$body["descripcion"],$body["estado"],$body["autor"],$body["estilo"]);
            if($datos=="ok"){
        ...
        case "UpartM":
            $datos=$categoria->update_articulosIMG($body["id"],$body["nom_articulo"],$body["sub_categoria"],$body["descripcion"],$body["estado"],$body["autor"],$body["estilo"],$body["id_img"],$body["enlace"],$body["fecha"],$body["hora"],$body["estado_img"]);
            if($datos=="ok"){
                echo json_encode(array('status' => 'Actualizado Correctamente'));}
            else{
                echo json_encode($datos);}
    ...
    /*Inicio Métodos para CRUD Usuarios*/
        ...
        break;
        case "Setusu":
            $datos=$categoria->insert_usuario($body["usuario"],$body["nombre"],$body["apellido"],$body["correo"],$body["pass"],$body["tip_user"],$body["img"],$body["descripcion"]);
            if($datos=="ok"){
                echo json_encode(array('status' => 'Guardado Correctamente'));}
            else{
                echo json_encode($datos);}
        break;
        case "Upusu":
            $datos=$categoria->update_usuario($body["id_user"],$body["nombre"],$body["apellido"],$body["correo"],$body["pass"],$body["tip_user"],$body["estado"],$body["img"],$body["descripcion"]);
            if($datos=="ok"){
                echo json_encode(array('status' => 'Actualizado Correctamente'));}
            else{
                echo json_encode($datos);}
